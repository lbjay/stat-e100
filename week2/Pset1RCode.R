...
# 1. What are the variables in the data set?
View(Titanic)
names(Titanic)
...
# 3. Based on this data set, what proportion of men survived the Titanic, 
# approximately? 
tally(~Survived | Gender, format = "proportion", data = Titanic, margins=TRUE)

# 4. Among those in the lower class, what proportion survived the Titanic, 
# approximately?
